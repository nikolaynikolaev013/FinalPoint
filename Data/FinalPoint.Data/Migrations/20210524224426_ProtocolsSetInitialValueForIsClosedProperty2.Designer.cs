...
namespace FinalPoint.Data.Migrations
{
    ...
    [Migration("20210524224426_ProtocolsSetInitialValueForIsClosedProperty2")]
    partial class ProtocolsSetInitialValueForIsClosedProperty2
    {
            ...
            modelBuilder.Entity("FinalPoint.Data.Models.Protocol", b =>
                {
                    ...
                    b.HasOne("FinalPoint.Data.Models.Office", "From")
                        .WithMany()
                    ...
                    b.HasOne("FinalPoint.Data.Models.Office", "To")
                        .WithMany()
                        .HasForeignKey("ToId");
